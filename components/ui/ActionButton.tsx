...
export default function ActionButton({ label, icon: Icon, href, onClick, variant = "secondary" }: ActionButtonProps) {
  ...
  const commonClasses = `flex items-center gap-2.5 px-5 py-2.5 rounded-xl font-bold text-sm transition-all active:scale-95 ${styles[variant]}`;

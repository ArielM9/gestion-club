...
1. Añadir campo `fotoUrl` al modelo Socio si no existe
2. Crear API route para obtener presigned URLs de S3/MinIO
3. Crear componente de upload de foto en formulaire de jugador
4. Integrar con la ficha del jugador para mostrar la foto
